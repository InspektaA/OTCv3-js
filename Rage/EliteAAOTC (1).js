...
function AA( )
{
var yawstand=UI.GetValue("Misc", "JAVASCRIPT", "Script items", "Yaw");
var yawstandinvert=UI.GetValue("Misc", "JAVASCRIPT", "Script items", "Inverted Yaw");
var enabled = UI.GetValue("Misc", "JAVASCRIPT", "Script items", "Custom AA");
    if(enabled == 1) {

 AntiAim.SetOverride(1);
UI.SetValue("Anti-Aim", "Rage Anti-Aim","Yaw offset",yawstand);
...
UI.SetValue("Anti-Aim", "Rage Anti-Aim","Yaw offset",yawstandinvert);
...
function Slow() {
var yawslow=UI.GetValue("Misc", "JAVASCRIPT", "Script items", "YawS");
var yawslowinvert=UI.GetValue("Misc", "JAVASCRIPT", "Script items", "Inverted YawS");
  var enabled = UI.GetValue("Misc", "JAVASCRIPT", "Script items", "Custom AA");
    if(enabled == 1) {
...
if (!UI.IsHotkeyActive("Misc", "JAVASCRIPT", "Script items", "Inverter")) {
    AntiAim.SetRealOffset(UI.GetValue("Misc", "JAVASCRIPT", "Script items", "Inverted FakeS"));
     UI.SetValue("Anti-Aim", "Rage Anti-Aim","Yaw offset",yawslowinvert);
}
...
function Air() {
var yawair=UI.GetValue("Misc", "JAVASCRIPT", "Script items", "YawA");
var yawairinvert=UI.GetValue("Misc", "JAVASCRIPT", "Script items", "Inverted YawA");

  var enabled = UI.GetValue("Misc", "JAVASCRIPT", "Script items", "Custom AA");
    if(enabled == 1) {
    if (!UI.IsHotkeyActive("Misc", "JAVASCRIPT", "Script items", "In Air(Jump Key)")) return;
      AntiAim.SetOverride(1);
       UI.SetValue("Anti-Aim", "Rage Anti-Aim","Yaw offset",yawair);
...
if (!UI.IsHotkeyActive("Misc", "JAVASCRIPT", "Script items", "Inverter")) {
    AntiAim.SetRealOffset(UI.GetValue("Misc", "JAVASCRIPT", "Script items", "Inverted FakeA"));
       UI.SetValue("Anti-Aim", "Rage Anti-Aim","Yaw offset",yawairinvert);
}
