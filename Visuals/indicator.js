...
function drawString()
{
    ...
    if(drawLeft)
    {
        Render.Polygon([LPx, LPz, LPy], [selected_red,selected_blue,selected_green,selected_alpha] );
    }
    else if(drawRight)
    {    
        Render.Polygon([RPy, RPz, RPx], [selected_red,selected_blue,selected_green,selected_alpha] );
    }
    else if(drawBack)
    {
        Render.Polygon([BPy, BPx, BPz], [selected_red,selected_blue,selected_green,selected_alpha] );
    }
}}
